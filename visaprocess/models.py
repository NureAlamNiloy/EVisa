...
class VisaApplication(models.Model):
    ...
    passport_front_photo = models.ImageField(null=True, blank=True, upload_to=passport_photo_upload_to)
    passport_back_photo = models.ImageField(upload_to=passport_photo_upload_to)
