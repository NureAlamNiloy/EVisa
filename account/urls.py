...
from .views import RegisterView,LoginViewset, AdminLoginViewset, LogoutViewset, VerifyOTP, ChangePasswordView, SendResetPasswordEmailView, ResetPasswordView

urlpatterns = [
    path('register/',RegisterView.as_view(), name="register"),
    path('login/', LoginViewset.as_view(), name="login"),
    path('adminlogin/', LoginViewset.as_view(), name="adminlogin"),
